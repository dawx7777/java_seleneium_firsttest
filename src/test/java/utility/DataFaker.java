...
public class DataFaker {
    ...
    public String getFakeZipCode(){return  faker.address().zipCode().substring(0,6);}
    public  String getFakeState(){return faker.address().state();}
    public String getFakeMobilePhone(){return faker.phoneNumber().cellPhone();}
    public String getFakeOrderReferences(){return  faker.name().name();}
    public String getFakeContactEmail(){return  faker.internet().emailAddress();}
    public String getFakeMessage(){return  faker.name().name();}
    public String getFakeFile(){return  faker.file().fileName();}
